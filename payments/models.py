...
class Method(models.Model):
    ...
    type_ = models.CharField(choices=PaymentMethodChoices.choices) # 결제수단
...
class Payment(CommonModel):
    ...
    price = models.DecimalField(null=False) # 상품가격
    delivery_fee = models.DecimalField(null=False) # 배송비
    amount = models.DecimalField(null=False) # 최종결제금액 (상품가격 + 배송비)
